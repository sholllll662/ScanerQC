                    ...
                    <div class="card text-bg-secondary">
                        <div class="card-body">
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="text" class="form-control" placeholder="PIC" aria-label="Username" aria-describedby="addon-wrapping" id="pic" name="pic">
                            </div>
                    ...
                    <div class="card text-bg-secondary">
                        <div class="card-body">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Jam Mulai" aria-label="Username" id="jam_mulai" name="jam_mulai">
                                <input type="text" class="form-control" placeholder="Jam Selesai" aria-label="Server" id="jam_selesai" name="jam_selesai">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" id="part_number" name="part_number">
                            </div>

                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Lot Number</span>
                                <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" id="lot_number" name="lot_number">
                            </div>

                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Quantity" aria-label="Username" aria-describedby="basic-addon1" id="qty_check" name="qty_check">
                                <input type="text" class="form-control" placeholder="Qyt NG" aria-label="Username" aria-describedby="basic-addon1" id="qty_ng" name="qty_ng">
                                <input type="text" class="form-control" placeholder="Qyt FG" aria-label="Username" aria-describedby="basic-addon1" id="qty_oke" name="qty_oke">
                            </div>
                        </div>
                    </div>
                </div>
